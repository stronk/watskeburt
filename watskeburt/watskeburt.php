...
Description: Elke keer een andere frase van dit fr&ecirc;le bloempje uit het rijke &oelig;uvre van de Jeugd van Tegenwoordig
Author: Stronk
Version: 1.0
...
function watskeburt_get_lyric() {
	/** These are lyrics bij the Dutch poets savants ensembled in the formation The Youth of Nowadays */
	$rijms = 
...
Vieze Freddy, alsof je dat niet wist en ik drink tot de motherfucking fles leeg is
...
Komt alleen uit m'n achterste moeders met dochters ze verachten me
Ben van baksteen, alsof je dat niet ruikt want de een is dik en de ander gebruikt
Ik ben tuig, van de eerste klasse en je wast je handen al tijdens het plassen
...
Dus ik zeg fuck jou man ik verkoop d'r crack stomme slet
